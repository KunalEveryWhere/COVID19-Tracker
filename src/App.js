...
import { Cards, Chart, CountryDropDown, News } from "./components";
import { fetchData } from "./api";
import logo from "./resources/covid-tracker.svg";
...
class App extends React.Component {
  ...
  handleChangeOnCountry = async (country) => {
  ...
  render() {
    if (!this.state.data.confirmed) {
      console.log(
        "Hey there.\n\nLooking for Something ?\nContact me: kunaleverywhere@outlook.com\n\nHappy to Help ｡◕‿◕｡"
      );
      return this.Loader();
    }
    return (
    ...
    return (
      <React.Fragment>
        <div className="header">
          <a href="https://www.kunaleverywhere.com" target="_blank">
  ...
  Background() {
    return (
      <React.Fragment>
        <div className="background_mob"></div>
        <div className="background_pc">
          <div id="love_is_good_logo">
            <svg
              version="1.1"
              id="Layer_1"
              ...
              x="0px"
              y="0px"
              viewBox="0 0 384.616 36.652"
              enableBackground="new 0 0 384.616 36.652"
            >
              <path
                fill="url(#skyGradient)"
                d="M26.922,34.046c0,0.159-0.06,0.3-0.18,0.42c-0.12,0.12-0.26,0.18-0.42,0.18c-0.32,0-0.52-0.133-0.6-0.4L14.083,4.886
    ...
    C26.755,33.579,26.922,34.02,26.922,34.046z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M69.282,34.025c0,0.414-0.214,0.62-0.64,0.62H49.678c-0.397,0-0.596-0.2-0.596-0.6V3.445c0-0.16,0.062-0.3,0.186-0.42
    ...
    C69.068,33.405,69.282,33.612,69.282,34.025z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M97.922,18.646c0,2.214-0.42,4.294-1.26,6.24c-0.84,1.946-1.98,3.64-3.42,5.079c-1.44,1.44-3.134,2.581-5.08,3.421
    ...
    c1.346-1.347,2.406-2.913,3.18-4.7C96.295,22.579,96.682,20.672,96.682,18.646z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M126.442,3.246c0,0.054-0.167,0.507-0.5,1.36c-0.334,0.854-0.767,1.967-1.3,3.34c-0.534,1.374-1.147,2.934-1.84,4.68
    ...
    C126.382,2.945,126.442,3.085,126.442,3.246z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M154.761,33.966c0,0.16-0.054,0.313-0.16,0.46c-0.107,0.146-0.254,0.22-0.44,0.22h-19.619c-0.193,0-0.352-0.066-0.476-0.2
    ...
    c-0.134,0.129-0.28,0.193-0.44,0.193h-15v11.8h19.04c0.16,0,0.3,0.074,0.42,0.221S154.761,33.806,154.761,33.966z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M193.921,34.046c0,0.159-0.067,0.3-0.2,0.42c-0.134,0.12-0.28,0.18-0.44,0.18c-0.214,0-0.374-0.08-0.48-0.24l-16.04-22.52
    ...
    z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M238.081,18.646c0,2.214-0.42,4.294-1.26,6.24s-1.98,3.64-3.42,5.079c-1.44,1.44-3.134,2.581-5.08,3.421
    ...
    s2.406-2.913,3.18-4.7C236.454,22.579,236.84,20.672,236.84,18.646z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M260.96,3.266c0,0.166-0.06,0.311-0.18,0.434c-0.12,0.124-0.26,0.186-0.42,0.186h-19.68c-0.16,0-0.301-0.062-0.42-0.186
    ...
    C261.067,6.813,261.121,6.965,261.121,7.125z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M303.401,34.025c0,0.414-0.214,0.62-0.641,0.62h-18.964c-0.397,0-0.596-0.2-0.596-0.6V3.445c0-0.16,0.062-0.3,0.186-0.42
    ...
    c0.128-0.133,0.271-0.2,0.426-0.2c0.413,0,0.62,0.213,0.62,0.639v30.121h14.439C303.187,33.405,303.401,33.612,303.401,34.025z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M332.041,18.646c0,2.214-0.42,4.294-1.26,6.24s-1.98,3.64-3.42,5.079c-1.44,1.44-3.134,2.581-5.08,3.421
    c-1.947,0.84-4.027,1.26-6.24,1.26c-2.214,0-4.294-0.42-6.24-1.26s-3.64-1.98-5.08-3.421c-1.439-1.439-2.58-3.133-3.42-5.079
    s-1.26-4.026-1.26-6.24c0-2.213,0.42-4.293,1.26-6.24c0.84-1.946,1.98-3.64,3.42-5.08c1.44-1.44,3.134-2.58,5.08-3.42
    c1.946-0.84,4.026-1.26,6.24-1.26c2.213,0,4.293,0.42,6.24,1.26c1.946,0.84,3.64,1.98,5.08,3.42c1.439,1.44,2.58,3.134,3.42,5.08
    ...
    s2.406-2.913,3.18-4.7C330.414,22.579,330.8,20.672,330.8,18.646z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M358.04,26.034c0,1.442-0.313,2.704-0.938,3.785c-0.626,1.081-1.451,1.977-2.476,2.684c-1.025,0.708-2.17,1.242-3.435,1.602
    ...
    c1.224,0.348,2.314,0.82,3.272,1.422s1.73,1.361,2.315,2.283C357.747,23.411,358.04,24.593,358.04,26.034z"
              ...
              <path
                fill="url(#skyGradient)"
                d="M382.72,3.266c0,0.166-0.06,0.311-0.18,0.434c-0.12,0.124-0.26,0.186-0.42,0.186h-19.68c-0.16,0-0.301-0.062-0.42-0.186
    c-0.12-0.124-0.181-0.269-0.181-0.434c0-0.165,0.061-0.31,0.181-0.434c0.119-0.124,0.26-0.186,0.42-0.186h19.68
      ...
      <React.Fragment>
        <div className="footer">
          <div className="attribute">
            ...
            {" | "}Also thanks to{" "}
            <a href="https://developer.smartable.ai/" target="_blank">
              <small>smartable.ai</small>
            </a>
          </div>
          <div className="socials">
            Designed by{" "}
            <a href="https://www.kunaleverywhere.com" target="_blank">
              <small>Kunal Prasad</small>
            </a>
            <br />
            All Rights Reserved{" "}
            <a href="https://www.kunaleverywhere.com" target="_blank">
              <small>KunalEveryWhere ©</small>
            </a>
          </div>
        </div>
      </React.Fragment>
  ...
  Chart() {
    ...
    if (window.innerHeight > window.innerWidth) {
      ...
      ele = <Chart data={this.state.data} country={this.state.country} />;
    }
    return ele;
  }
  CountryDropDown() {
    return (
      <CountryDropDown handleChangeOnCountry={this.handleChangeOnCountry} />
    );
  }
}
export default App;
